...
}`}};function Lt(s){let e=Ot;return s.split("/").forEach(n=>{e&&(e=e[n])}),e}const At=new Ce(Lt);function X(s){return At.resolveIncludes(s)}X("background/background.vert"),X("background/background.frag"),new Map([["a_pos",0]]);function H(s){let e="";for(const n in s){const t=s[n];if(typeof t=="boolean")t&&(e+=`#define ${n}
